...
public partial class BlogEditDialog : UserComponent<BlogEditDialogModel>
{
    public BlogEditDialog()
    {
        InitializeComponent();
    }
}

public partial class BlogEditDialogModel : BaseFormDialogModel<BlogEditDto>, IRefresh
{
    ...
    public BlogEditDialogModel()
    {
        // Design
    }

    public BlogEditDialogModel(IBlogService blogService, IGlobalNotify notify, ITagService tagService,
